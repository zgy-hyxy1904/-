...
@Repository
public class SoilMoniDaoImpl extends BaseDaoImpl<SoilMoni, Serializable>  implements SoilMoniDao {
	@Autowired
	...
	public SoilMoni getSoilMoni(int id) {
		return (SoilMoni) currentSession().get(SoilMoni.class, Integer.valueOf(id));
	}

	@Override
	public void save(SoilMoni soilMoni) {
		currentSession().saveOrUpdate(soilMoni);
	}

	@Override
	public void delete(int id) {
		Session session = currentSession();
		SoilMoni soilMoni = (SoilMoni) session.get(SoilMoni.class, Integer.valueOf(id));
		session.delete(soilMoni);
	}
	...
	public List<SoilMoni> getSoilMoniList() {
		String sql = " from SoilMoni where deleteFlag='N'";
