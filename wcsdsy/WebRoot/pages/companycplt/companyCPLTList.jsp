...
<script type="text/javascript" src="${ctx}/js/common.js?v111"></script>
				...
				<table class="table_common_style">
					<tr>
						...
						<td class="table_common_td_txt_query_style">
							<simple:select id="companyCode" name="companyCode" codeKey="02" hasPleaseSelectOption="true" value="${companyCode}" entityName="Company" />
						</td>
		...
		<table id="data" class="easyui-datagrid" striped="true" singleSelect="false" pageSize="${pageModel.pageSize}" pageNumber="${pageModel.page}">
			...
			<tbody>
				...
				<tr>
					...
					<td height="30" align="center" nowrap>
						<fmt:formatDate value="${companyCPLT.complaintDate}" pattern="yyyy-MM-dd"/>
					</td>
