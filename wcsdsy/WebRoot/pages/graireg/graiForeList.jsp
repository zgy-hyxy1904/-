		...
		<table id="data" class="easyui-datagrid" striped="true" singleSelect="false" pageSize="${pageModel.pageSize}" pageNumber="${pageModel.page}">
			...
			<tbody>
				...
				<tr>
					...
					<td></td>
					<td>合计：</td>
					<td><fmt:formatNumber type="number" value="${pageModel.data.actualMu}" pattern="0.00" maxFractionDigits="2"/></td>
					<td><fmt:formatNumber type="number" value="${pageModel.data.measurementMu}" pattern="0.00" maxFractionDigits="2"/></td>
					<td><fmt:formatNumber type="number" value="${pageModel.data.minEstimateTotalYield}" pattern="0.00" maxFractionDigits="2"/>
						</br>
						<fmt:formatNumber type="number" value="${pageModel.data.maxEstimateTotalYield}" pattern="0.00" maxFractionDigits="2"/>
					<td></td>
				</tr>		
			</tbody>
		</table>
...
function importTempDown(){
	document.location.href = "${ctx}/temp/收粮预报模板.xlsx";
}
</script>
</body>
</html>