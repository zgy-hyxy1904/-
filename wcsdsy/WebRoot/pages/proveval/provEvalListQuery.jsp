			...
			<form id="inputForm" name="inputRegForm" method="get" action="../provEval/listquery">
				...
				<table class="table_common_style">
					<tr>
						...
						<td class="table_common_td_txt_query_style">
						<c:if test="${sessionScope.isCompanyUser==false }">
							<simple:select
								id="companyCode" 
								name="companyCode" 
								codeKey="01" 
						...
						<c:if test="${sessionScope.isCompanyUser==true }">
		...
		<fieldset id="infoBlock" class="fieldset_common_style">
			<table class="table_common_style">
				...
				<tr>
					...
					<td colspan="3" class="table_common_td_txt_style">
						<input type="text" readonly="readonly" size="25"  value='<fmt:formatNumber type="number" value="${minYield}" pattern="0.00" maxFractionDigits="2"/>' class="easyui-textbox"/>
						~
						<input type="text" readonly="readonly" size="25"  value='<fmt:formatNumber type="number" value="${maxYield}" pattern="0.00" maxFractionDigits="2"/>' class="easyui-textbox"/>
					</td>
				</tr>
			</table>	
		</fieldset>
		<table id="data" class="easyui-datagrid" striped="true"  singleSelect="false" pageSize="${pageModel.pageSize}" pageNumber="${pageModel.page}">
			...
			<tbody>
				...
				<tr>
					...
					<td height="30" align="center" nowrap>${provEval.homeAddress}</td>
					<td height="30" align="center" nowrap>${provEval.archiveDate}</td>
					<td height="30" align="center" nowrap>${provEval.archiveAcreage}</td>
					<td height="30" align="center" nowrap>${provEval.landType}</td>
				</tr>
				</c:forEach>		
			</tbody>
		</table>
