...
<body class="easyui-layout">
	<div region="center" border="false" style="padding: 5px;">
			...
			<form id="inputForm" name="inputForm" method="get"
				...
				<table class="table_common_style">
					<tr>
						...
						<td class="table_common_td_txt_query_style"><input class="easyui-datebox" id="beginDate" name="beginDate"
							value="${beginDate }"
							data-options="required:false,showSeconds:false"
							style="width: 150px" editable="false" /> ~ <input
							class="easyui-datebox" id="endDate" name="endDate" value="${endDate }"
							data-options="required:false,showSeconds:false"
		...
		<table id="data" class="easyui-datagrid" striped="true"
			...
			<tbody>
				<c:forEach var="airMoni" items="${pageModel.result}"
					varStatus="status">
					<tr>
						<td height="30" align="center" nowrap>${airMoni.id}</td>
						<td height="30" align="center" nowrap><fmt:formatDate
								value="${airMoni.monitorDate}" pattern="yyyy-MM-dd" /></td>
						<td height="30" align="center" nowrap>${airMoni.monitorPointName}</td>
						<td height="30" align="center" nowrap>${airMoni.tsp}</td>
						<td height="30" align="center" nowrap>${airMoni.so2}</td>
						<td height="30" align="center" nowrap>${airMoni.no2}</td>
						<td height="30" align="center" nowrap>${airMoni.createUserId}</td>
						<td height="30" align="center" nowrap><fmt:formatDate
								value="${airMoni.createDate}" pattern="yyyy-MM-dd " /></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
