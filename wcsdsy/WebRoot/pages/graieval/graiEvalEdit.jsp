...
<body class="easyui-layout" >
	<div region="center" border="false" style="padding:5px;">	
		<form id="addFrom" class="easyui-form" method="post" data-options="novalidate:true">
			<input type="hidden" name="id" id="id" value="${graiEval.id}">
				...
				<table class="table_common_style">
	    			...
	    			<c:if test="${ readOnlyFlag == 1 }">
	    				<td class="table_common_td_txt_style">
	    					<simple:select id="year3" name="year" value="${year}" entityName="YearCode" width="187" canEdit="false" readOnly="true"/>
	    				</td>
	    			</c:if>
	    			<c:if test="${ readOnlyFlag == 0 }">
	    				<td class="table_common_td_txt_style editableFalse">
	    			    	<simple:select id="year3" name="year" value="${year}" entityName="YearCode" width="187" canEdit="false"/>
	    			...
	    			<tr>
		    			...
		    			<td class="table_common_td_txt_style">
		    				<input class="easyui-numberbox" precision="1" type="text" name="minYield" value="${graiEval.minYield }" data-options="min:0,max:999999999.99,precision:2,groupSeparator:','" style="width:187px;"></input>
		    				<span class="span_common_mustinput_style">*</span>
		    			</td>
	    			</tr>
	    			<tr>
		    			...
		    			<td class="table_common_td_txt_style">
		    				<input class="easyui-numberbox" precision="1" type="text" name="maxYield" value="${graiEval.maxYield }" data-options="min:0,max:999999999.99,precision:2,groupSeparator:','"  style="width:187px;"></input>
		    				<span class="span_common_mustinput_style">*</span>
		    			</td>
	    			</tr>
	    			<tr>
		    			...
		    			<td class="table_common_td_txt_style">
		    				<input class="easyui-numberbox" precision="2"  type="text" name="milledriceRate" value="${graiEval.milledriceRate }" data-options="min:0,max:99999.9999,precision:2,groupSeparator:','"  style="width:187px;"></input>
		    				<span class="span_common_mustinput_style">*</span>
		    			</td>
	    			</tr>
	    			<tr height="80">
...
function formCheck(){
	if(!check()) return ;
	var year = $("#year3").combobox('getValue');
