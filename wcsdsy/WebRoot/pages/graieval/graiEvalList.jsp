		...
		<table id="data" class="easyui-datagrid" striped="true" singleSelect="false" pageSize="${pageModel.pageSize}" pageNumber="${pageModel.page}">
			...
			<tbody>
				...
				<tr>
					...
					<td height="30" align="center" nowrap>${graiEval.year}</td>
					<td height="30" align="center" nowrap>
						<simple:showName entityName="seedVariety" value="${graiEval.seedCode}"></simple:showName>
					</td>
					<td height="30" align="center" nowrap>${graiEval.minYield}</td>
					<td height="30" align="center" nowrap>${graiEval.maxYield}</td>
					<td height="30" align="center" nowrap>${graiEval.milledriceRate}</td>
				</tr>
				</c:forEach>		
			</tbody>
		</table>
