			...
			<form id="inputForm" name="inputForm" method="get" action="../specLandReg/list">
				...
				<table class="table_common_style">
					...
					<tr>
						...
						<td class="table_common_td_txt_query_style">
							<simple:select id='status' name="status" value="${status}" codeKey="SpecialRegistStatus" entityName="commonData" hasPleaseSelectOption="true" width="187"/><BR>
						</td>
		...
		<table id="data" class="easyui-datagrid" striped="true" singleSelect="false" pageSize="${pageModel.pageSize}" pageNumber="${pageModel.page}">
			...
			<tbody>
				...
				<tr>
					...
					<td height="30" align="center" nowrap><fmt:formatDate value="${specLandReg.auditTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
...
function edit(id){
	...
	var id = rows[0].id;
	var url = "${ctx}/specLandReg/editInput?retFlag=1&id=" + id;
	url += getQueryCond();
	document.location.href = url;
}
function add(id){
	var url = "${ctx}/specLandReg/editInput?retFlag=1";
	url += getQueryCond();
	document.location.href = url;
}
...
function view(){
	...
	var url = "${ctx}/specLandReg/view?id=" + id + "&gotoPage=1";
	url += "&year=" + year;
