			...
			<fieldset class="fieldset_common_style">
				<table class="table_common_style">
					...
					<tr>
						...
						<td class="table_common_td_txt_style">
							<input class="easyui-textbox" type="text" name="contractorName" value="${specLandReg.contractorName }" style="width:188px;" maxlength="10"></input>
							<span class="span_common_mustinput_style">*</span>
						</td>
						<td class="table_common_td_label_style">证件号码：</td>
						<td class="table_common_td_txt_style">
							<input class="easyui-textbox" type="text" name="contractorID" value="${specLandReg.contractorID }" style="width:188px;"></input>
							<span class="span_common_mustinput_style">*</span>
						</td>
					</tr>
					<tr>
			...
			<fieldset class="fieldset_common_style">
				<table class="table_common_style">
					<tr>
						...
						<td class="table_common_td_txt_style">
							<input  class="easyui-numberbox" precision="2" min="0.00" max="9999999.99"  name="actualMu" value="${actualMu }" style="width:120px;"></input>
							<span class="span_common_mustinput_style">*</span>
						</td>
			...
			<fieldset class="fieldset_common_style">
				<table class="table_common_style">
					...
					<tr>
						...
						<td class="table_common_td_txt_style">
							<input  class="easyui-numberbox" precision="2" min="0.00" max="9999999.99" type="text" name="archiveAcreage" value="<f:formatNumber type="number" value="${specLandReg.archiveAcreage }" pattern="0.00" maxFractionDigits="2"/>" style="width:100px;"></input>
							<span class="span_common_mustinput_style">*</span>
						</td>
						<td class="table_common_td_label_style">经办人：</td>
						<td class="table_common_td_txt_style">
							<input class="easyui-textbox" type="text" name="operatorName" value="${specLandReg.operatorName }" style="width:100px;"></input>
							<span class="span_common_mustinput_style">*</span>
						</td>
						<td class="table_common_td_label_style">经办日期：</td>
						<td class="table_common_td_txt_style editableFalse">
							<input class="easyui-datebox" name="operatorDate" id="operatorDate" value="${ specLandReg.operatorDate}"
       data-options="required:true,showSeconds:false" style="width:100px" editable="false" >
					...
					<tr>
						...
						<td colspan="5" class="table_common_td_txt_style">
							<textarea class="easyui-textbox" rows="3" id="description" name="description" cols="60" style="width:500px;height:100px" data-options="multiline:true">${specLandReg.description }</textarea>
							<span class="span_common_mustinput_style">*</span>
						</td>
					</tr>
				</table>
			...
			<fieldset class="fieldset_common_style">
				...
				<table class="table_common_style">
					<tr>
						<td>
							<a href="#" class="easyui-linkbutton" onclick="javascript:showUploadDialog('04', '${specLandReg.id}', '举证资料', 'imgPriviewOuter', 'imgPriviewInner');">
